...
public class PwService : BaseElasticService<PW, PwDto, string>, IPwService, ITransient
{
    /// <summary>
    /// 
    /// </summary>
    public PwService(ILogger<PW> logger,
                        IATCerEsClient client,
                        ICache cache
                        ) : base(client, cache, logger, IndexNames.MetData_PW)
    {
