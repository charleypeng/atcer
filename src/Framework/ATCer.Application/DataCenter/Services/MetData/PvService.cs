...
public class PvService : BaseElasticService<PV, PvDto, string>, IPvService, ITransient
{
    /// <summary>
    /// 
    /// </summary>
    public PvService(ILogger<PvService> logger,
                        IATCerEsClient client,
                        ICache cache
                        ) : base(client, cache, logger, IndexNames.MetData_PV)
    {
