...
/// 
/// </summary>
public class RainWorker : BaseRadarWorker<RainDto,string>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public RainWorker(IRainService client, ILogger<RainWorker> logger):base(client, logger)
    {
    ...
    /// <returns></returns>
    [CapSubscribe("datacenter.met.raw.rain", Group = "metdata")]
