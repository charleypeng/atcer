    ...
    public class ClientServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="根据客户端编号获取绑定的接口列表",Key="BB9E3C06F2507147FADEA21712CB70CA",Path="/api/client/{id}/functions",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("3a6f74c2-0165-46b0-8cd5-1846846d97bc"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="逻辑删除",Key="EFC227D985161F0ED01B189C5CCF532F",Description="根据主键逻辑删除",Path="/api/client/fake-delete/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("037d2517-d1fa-4b5f-adba-a8f4aae6c205"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="登录",Key="6050B0AE0242E8D1D8A6B5B0EAFFA1E0",Description="登录接口",Path="/api/client/login",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("20b44c15-481f-4bba-8905-3e5f983927b0"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="根据主键获取",Key="8B2F2030F705698FEA9D98536F415ADD",Description="根据主键查找一条数据",Path="/api/client/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("4c1b9201-09e6-421f-95d1-d98d009a3417"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="根据客户端编号获取绑定的接口列表",Key="AF36C639E9127D2C3B5ECB8FE54D26A4",Description="",Path="/api/client/{id}/functions",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("5c0a6241-ac2d-442f-9c6c-028566f18b6a"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="更新",Key="4326F39D4D047A58AA7887EEB0A5B5A3",Description="更新一条数据",Path="/api/client",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("cecdfb7d-6796-4bd8-a3d7-164c16a7c959"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="查询所有",Key="C75F9424DD51498CD9ADBFCBF2EB4D57",Description="查找到所有数据",Path="/api/client/all",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("f16b30b9-9e03-48d7-83a1-f09ae3e05345"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="查询所有可以用的",Key="6069031816C15D92B60A246C9CAD1287",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/client/all-usable",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("f72f5e71-46f6-44eb-8a3d-f07082fa33e5"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="锁定",Key="6D9355E642310F188E728A62002A6879",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/client/{id}/lock/{islocked}",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("fc90ab49-b7c2-437e-bbdc-4f234cb0f79a"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
         };
        }
