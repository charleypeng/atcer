    ...
    public class PositionServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="岗位管理服务",Summary="查询所有可以用的",Key="C47AACD68B1EF833AAC0EC90CD878FDD",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/position/all-usable",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("b56c4126-411c-445e-86aa-a91a5ce816d4"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="岗位管理服务",Summary="搜索",Key="9A501F3D2F0A3A2D47A17D6F42042CD5",Description="搜索数据",Path="/api/position/search",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="岗位管理服务",Summary="分页查询",Key="F543F08AB768F7D444481F5D7EB52373",Description="根据分页参数，分页获取数据",Path="/api/position/page/{pageindex}/{pagesize}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("d22007c6-fada-4ef1-bafa-08455b767883"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
