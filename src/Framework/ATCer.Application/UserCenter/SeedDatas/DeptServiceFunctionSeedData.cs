...
namespace ATCer.UserCenter.SeedDatas
{
    ...
    public class DeptServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        {
            return new[]{
                new Function() {Group="用户中心服务",Service="部门服务",Summary="生成种子数据",Key="298FD49C905F1B1B812B226B95307CE0",Description="根据搜索条叫生成种子数据",Path="/api/dept/generate-seed-data",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("c2784668-075f-4b7e-a563-b6b92b072542"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="部门服务",Summary="锁定",Key="8AED5C0B53588415D98E97119880AC6A",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/dept/{id}/lock/{islocked}",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("0d2df690-6aa7-466b-b1e4-73fa4fda1b5d"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="部门服务",Summary="根据主键获取",Key="213D1BBDB567A74636ACE841D780F663",Description="根据主键查找一条数据",Path="/api/dept/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("2502e6ae-879b-4674-a557-cd7b4de891a7"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="部门服务",Summary="删除",Key="EA96F9C3B67BB0EB8E3D5337D3482162",Description="根据主键删除一条数据",Path="/api/dept/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("333edf31-c542-4fa1-baca-b770d558a4d7"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="部门服务",Summary="获取种子数据",Key="EFFE9D726D7792B023DF91E15AA48C89",Path="/api/dept/seed-data",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("ff8621c9-1b88-4e6d-be00-34615c48c69f"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="部门服务",Summary="获取所有部门数据，以树形结构返回",Key="98B6A43EC42A6B9F1D8257EE1D05E9BB",Path="/api/dept/tree/{includelocked}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-09-05 17:42:02"),Id=Guid.Parse("6e2ff941-1e79-4e2a-bbe9-ec68318e5d3a"),},
