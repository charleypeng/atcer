...
namespace ATCer.LTFATCenter.DbContexts
{
    ...
    public class SugarTest : AppDbContext<SugarTest, SugarTestLocator>
    {
        /// <summary>
        /// 初始化
        /// </summary>
        /// <param name="options"></param>
        public SugarTest(DbContextOptions<SugarTest> options) : base(options)
        {
        ...
        {
            builder.Entity<SugarTest>().ToTable("flightplan");
