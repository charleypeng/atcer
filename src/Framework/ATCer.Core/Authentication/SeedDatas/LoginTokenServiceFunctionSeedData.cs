...
namespace ATCer.Authentication.SeedDatas
{
    /// <summary>
    /// 种子数据
    /// </summary>
    public class LoginTokenServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="查询所有可以用的",Key="33D096038DC823412DC051FA7371FB68",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/login-token/all-usable",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("5328608a-6b71-4507-a52a-e1beffa7a4ab"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="逻辑删除",Key="A094FB1391CD1E7F7A2C7E8536A491DF",Description="根据主键逻辑删除",Path="/api/login-token/fake-delete/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("571200a8-bde2-430b-84ea-743db7b282cd"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="删除",Key="873AFCBA915D056ED9D8EDA9D23F9061",Description="根据主键删除一条数据",Path="/api/login-token/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("8f114b96-dc3d-4dd4-854a-4c793c121e43"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="更新",Key="2909033694587286F3458217843E20D8",Description="更新一条数据",Path="/api/login-token",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("a2e21aa5-c2ff-4893-954f-263822d168c3"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="分页查询",Key="4A8F7B6AB1E6A30A9A65FEBE2B31CE4A",Description="根据分页参数，分页获取数据",Path="/api/login-token/page/{pageindex}/{pagesize}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("e298058c-8ec9-4637-bf8b-4ece0bfa5a5b"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="搜索",Key="860A62FFC20FAAAE60E760D4305104DF",Description="搜索数据",Path="/api/login-token/search",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("e651d9a4-9d6d-44c7-a833-08da6ed19892"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="根据主键获取",Key="C01E9238420548B6CA87C312935DD043",Description="根据主键查找一条数据",Path="/api/login-token/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("f1267fbc-903b-4439-a7b6-a7290507d207"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="锁定",Key="B37ED1BEEE60098FACB7182C73B5FA3F",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/login-token/{id}/lock/{islocked}",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("f59833a1-c9af-4bb2-be4b-d6935513fc99"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="查询所有",Key="8C9ED3E66D288CA942AD438AD9C50DBF",Description="查找到所有数据",Path="/api/login-token/all",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("f6fd9621-f6e4-45ec-b919-6acb73c7b303"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="导出",Key="91D755377D8744A976836037290BB199",Description="导出数据",Path="/api/login-token/export",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:25:20"),Id=Guid.Parse("cd1b93ed-2fae-47f2-83b2-e9b0a949f476"),},
         };
        }
    }
