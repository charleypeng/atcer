    ...
    public class EmailServerConfigServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="锁定",Key="C0F3F05AE24A0E8BBA9BAF52852E09D4",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/email-server-config/{id}/lock/{islocked}",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("6c9aa43e-921c-44bc-83fb-64a9c451255f"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="删除",Key="BA79EB71501051CA1F082DE15FBE73D3",Description="根据主键删除一条数据",Path="/api/email-server-config/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("84247930-2035-443d-bde3-69d4d23bec85"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="更新",Key="D15206E2B2CEFD1CC520AF32A357F56E",Description="更新一条数据",Path="/api/email-server-config",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("99546746-70b8-42d6-884d-ea1b79f88c0a"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="根据主键获取",Key="4166A00DD3058EA57C09B869E68927D4",Description="根据主键查找一条数据",Path="/api/email-server-config/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("9d25bf25-5470-4fed-b58c-c4ef4339d533"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="搜索",Key="87C5CB00FB6A44D52C1C4CC5E9312B02",Description="搜索数据",Path="/api/email-server-config/search",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("9fe5cc45-a851-4d3f-8b44-32dd96130946"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="分页查询",Key="6946DB3F24E403A804F67F2B116C9392",Description="根据分页参数，分页获取数据",Path="/api/email-server-config/page/{pageindex}/{pagesize}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("d5e9621c-ad9f-4bca-aa51-04aa0b55744e"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="邮件服务器配置服务",Summary="查询所有",Key="5AE5AD783D5821E6D300DBE1BDD6E631",Description="查找到所有数据",Path="/api/email-server-config/all",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("d7fa048a-0bfd-4997-94e3-dda3402c3b08"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
         };
        }
    }
