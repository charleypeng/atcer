...
namespace ATCer.Attachment.SeedDatas
{
    /// <summary>
    /// 接口种子数据
    /// </summary>
    public class AttachmentServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="附件服务",Summary="根据主键获取",Key="271DFDC5E142CFE1AF0C4200C6DC060A",Description="根据主键查找一条数据",Path="/api/attachment/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("2f820c7f-4f1c-4737-aae6-329585c75d92"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="查询所有可以用的",Key="6B7B11626AE0ABB28C5331DB67DACAA0",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/attachment/all-usable",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("42b3486a-8ea0-4296-a526-7cd3ef9ea73a"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="锁定",Key="ADF53A6D1C062BF2CC40EBDE20D8E841",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/attachment/{id}/lock/{islocked}",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("5604fcc2-595f-4cc5-b0b8-c0d75a4c9351"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="搜索",Key="0C58B2617EA08ED81F14B53C00C678D7",Description="搜索数据",Path="/api/attachment/search",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("6a9763c9-c40f-44f3-a248-a3b1e3d1f586"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="删除",Key="085CB1560C82B28FE4C8C5F28EA31A59",Description="根据主键删除",Path="/api/attachment/{id}",Method=Enum.Parse<MyHttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("9c6cefe2-d57d-490c-8b0f-70749bc5cdfa"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="查询所有",Key="3CBCB4608120758739D941BFCCC09C18",Description="查找到所有数据",Path="/api/attachment/all",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("a3ea9c9f-da6f-48e1-8255-d250bb3e52d5"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="附件服务",Summary="分页查询",Key="9BE552AEF35878A71ABE8179B80AA036",Description="根据分页参数，分页获取数据",Path="/api/attachment/page/{pageindex}/{pagesize}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("aedc9e9c-f011-4d46-966e-3b14fd5298c2"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
