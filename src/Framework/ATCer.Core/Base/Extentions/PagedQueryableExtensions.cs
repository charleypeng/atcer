...
namespace ATCer
{
    ...
    public static class PagedQueryableExtensions
    {
        ...
        /// <returns></returns>
        public static MyPagedList<TEntity> ToPage<TEntity>(this IQueryable<TEntity> entities, int pageIndex = 1, int pageSize = 20)
        ...
        /// <returns></returns>
        public static async Task<MyPagedList<TEntity>> ToPageAsync<TEntity>(this IQueryable<TEntity> entities, int pageIndex = 1, int pageSize = 20, CancellationToken cancellationToken = default)
            where TEntity : class, new()
        {
