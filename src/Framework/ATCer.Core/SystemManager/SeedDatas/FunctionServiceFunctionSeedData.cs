    ...
    public class FunctionServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="功能服务",Summary="查询所有",Key="488BDECFA97ADDE5E940446C32C42693",Description="查找到所有数据",Path="/api/function/all",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("9caf800a-de55-4d59-a138-675a16924c3c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="功能服务",Summary="判断是否存在",Key="27693C4354A64289D9A1D3EB50E68E7E",Description="根据 HttpMethod 和 path 判断是否存在",Path="/api/function/exists/{method}/{path}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("a15ce231-80ae-46c6-ada8-49666e81e328"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="功能服务",Summary="更新",Key="E2248234B183BA3EEA82273CB03F500C",Description="更新一条数据",Path="/api/function",Method=Enum.Parse<MyHttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("aeb8b23d-4da3-4ec0-867f-70d2e2ba9550"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="功能服务",Summary="根据key获取",Key="CE34F0B4FCB2222CF693F501B370149D",Description="根据key获取 功能点",Path="/api/function/by-key/{key}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("b2dfaad3-e44a-4a76-ac91-34a571ba47e8"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="功能服务",Summary="查询所有可以用的",Key="1CCC2478B5AC5FDDB537DCD33166ABF7",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/function/all-usable",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("b79d2f63-487c-44c8-b7d3-1e882994789b"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="功能服务",Summary="根据主键获取",Key="FDD3EAB18820A6CD5C6DA3B17D40EEB9",Description="根据主键查找一条数据",Path="/api/function/{id}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("b952b41e-b3e9-4c53-9a7d-6b561acf4bc4"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="系统基础服务",Service="功能服务",Summary="导出",Key="C159134CE2D63BC05680B2AD2BB86E7C",Description="导出数据",Path="/api/function/export",Method=Enum.Parse<MyHttpMethod>("POST"),EnableAudit=true,IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:25:20"),Id=Guid.Parse("dca2b115-3363-4f7f-8bba-b051b8d8603a"),},
         };
        }
    }
