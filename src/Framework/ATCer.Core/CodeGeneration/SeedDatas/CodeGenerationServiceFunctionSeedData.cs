...
namespace ATCer.CodeGeneration.SeedDatas
{
    /// <summary>
    /// 接口种子数据
    /// </summary>
    public class CodeGenerationServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="代码生成服务",Summary="获取所有实体定义",Key="EC62EF7FF22A3D75FF0452966175ED6D",Path="/api/code-generation/entity-definitions",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("bfbcb606-6adb-460f-9730-20dbe3b32949"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="系统基础服务",Service="代码生成服务",Summary="获取实体的代码生成配置",Key="51CDF306434E8148436781B9BFB4D520",Path="/api/code-generation/entity-code-generation-setting/{entityfullname}",Method=Enum.Parse<MyHttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("f9feca89-9856-4c20-aa82-b2260df498a9"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
         };
        }
    }
