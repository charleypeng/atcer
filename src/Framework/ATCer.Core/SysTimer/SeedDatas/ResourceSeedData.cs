    ...
    public class ResourceSeedData : IEntitySeedData<Resource>
    {
        ...
        public IEnumerable<Resource> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Resource() {Name="导出任务调度",Key="system_manager_timer_export",Remark="导出任务调度",Order=0,ParentId=Guid.Parse("3d93eb77-2a72-4b4f-aa79-5da1fc794300"),Type=Enum.Parse<ResourceType>("Action"),IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:44:40"),Id=Guid.Parse("32809cde-b1bb-4076-a37b-6c9375e84aac"),},
         };
        }
    }
}