...
namespace ATCer.Base
{
    ...
    public interface IServiceBase<TEntityDto, TKey> where TEntityDto : class, new()
    {
        ...
        /// <returns></returns>
        Task<MyPagedList<TEntityDto>> GetPage(int pageIndex = 1, int pageSize = 10);
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<MyPagedList<TEntityDto>> Search(MyPageRequest request);
        ...
        /// 根据搜索条叫生成种子数据
        /// </remarks>
        Task<string> GenerateSeedData(MyPageRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<string> Export(MyPageRequest request);
    }
}