...
namespace ATCer.Client.Core
{
    ...
    public class SignalRClient : ISignalRClient
    {
        ...
        public SignalRClient(string clientName, string url, IClientLogger clientLogger, Func<Task<string?>> accessTokenProvider, Dictionary<string,string>? header = null)
        {
