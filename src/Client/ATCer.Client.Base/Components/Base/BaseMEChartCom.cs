...
/// 图表控件基类
/// </summary>
public abstract class BaseMECharts : BaseCom, INotifyPropertyChanged, IChartCom
{
    private object data;
    /// <summary>
    /// 数据
    ...
    /// </summary>
    [Parameter]
    public virtual bool LasyMode { get; set; } = false;
    /// <summary>
    /// 标题
    /// </summary>
    [Parameter]
    ...
    public virtual async Task RefreshData()
    {
        ...
        await chart.SetOption(data, LasyMode);
#if DEBUG
